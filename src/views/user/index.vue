<template>
  ...
  <div class="mobile">
    ...
    <div class="rectangle_333">
      ...
      <a href="https://71yunduan.com/user/acre_transfer.html"
        ><img src="@/assets/image/user/nav12.png" />
        <font>地产转账</font>
      </a>
      <a href="https://71yunduan.com/user/properties.html"
        ><img src="@/assets/image/user/nav16.png" />
        <font>房产申请</font>
      </a>
      <a href="https://71yunduan.com/user/policy.html"
    ...
    <ul class="user_list">
      ...
      <li>
        <a href="https://71yunduan.com/user/invest.html"
          ><img src="@/assets/image/user/u2.png" />我的申请</a
        >
      </li>
      <li>
        <a href="https://71yunduan.com/user/fund.html"
          ><img src="@/assets/image/user/u3.png" />我的账单</a
        >
      </li>
      <li>
        <a href="https://71yunduan.com/user/certification.html"
          ><img src="@/assets/image/user/u4.png" />实名认证</a
        >
      </li>
      <li>
        <a href="https://71yunduan.com/user/add_card.html"
          ><img src="@/assets/image/user/u5.png" />提现账户</a
        >
      </li>
      <li>
        <a href="https://71yunduan.com/user/pwd_login.html"
          ><img src="@/assets/image/user/u6.png" />密码修改</a
        >
      </li>
      <li>
        <a href="https://71yunduan.com/user/pwd_pay.html"
          ><img src="@/assets/image/user/u7.png" />支付密码修改</a
        >
      </li>
      <li>
        <a href="https://71yunduan.com/gs/sm_add_address.html"
          ><img src="@/assets/image/user/u7.png" />我的收件地址</a
        >
      </li>
    </ul>

    <a href="https://71yunduan.com/user/logout.html" class="input_btn" style="margin-bottom: 2rem"
      >退出登录</a
    >
