<template>
  <div v-if="hadLoad" class="">
    ...
    <div class="rectangle_333">
      ...
      <a @click="goPage({ name: 'zhuanzhang' })"
    ...
    <ul class="user_list">
      ...
      <li>
        <a @click="goPage({ name: 'myWallet', query: { title: '我的账单' } })"
          ><img src="@/assets/image/user/u3.png" />我的账单</a
        >
      </li>
      <li>
        <a @click="goPage({ name: 'certification' })"
      ...
      <li>
        <a @click="goPage({ name: 'editPassword' })"
          ><img src="@/assets/image/user/u6.png" />密码修改</a
        >
      </li>
      <li>
        <a @click="goPage({ name: 'editPayPassword' })"
          ><img src="@/assets/image/user/u7.png" />支付密码修改</a
        >
      </li>
      <li>
        <a @click="goPage({ name: 'addAddress' })"
